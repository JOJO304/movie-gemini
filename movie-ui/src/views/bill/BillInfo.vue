...
async editBillInfo() {
      ...
      if (_this.editForm.payState) {
        ...
        // 👇👇 核心修复点：1. 修复 sests 拼写错误； 2. 修复解析方式为 split(',') 👇👇
        let seatArray = _this.editForm.seats.split(',');
        ...
        this.getBillList()
        this.editDialogVisible = false
        this.$message.success('取消订单成功，座位已释放！')
      }
    },
